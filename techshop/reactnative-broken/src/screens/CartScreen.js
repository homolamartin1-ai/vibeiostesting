...
export default function CartScreen({ navigation }) {
  ...
  // ─────────────────────────────────────────────────────────────────
  // BUG-006: the order total is captured only when the NUMBER of items
  // changes (items.length), not when a quantity changes. Tapping + or -
  // updates the line total but leaves the order total stale.
  // The fix: depend on `total`, or read `total` directly in render.
  // ─────────────────────────────────────────────────────────────────
  ...
  function onProceed() {
    ...
    setMessage('');
    // ───────────────────────────────────────────────────────────────
    // BUG-011: this is a no-op. "Proceed to Checkout" does not respond.
    // The requirement is to navigate to the Checkout screen.
    // The fix: navigation.navigate('Checkout').
    // ───────────────────────────────────────────────────────────────
  }
